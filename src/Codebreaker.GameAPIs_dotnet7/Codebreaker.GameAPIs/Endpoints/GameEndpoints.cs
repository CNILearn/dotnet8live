...
public static class GameEndpoints
{
    public static void MapGameEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/", async (
            IGamesService gameService,
            [AsParameters] GetGamesRouteParameters parameters,
            CancellationToken cancellationToken) =>
                {
                    GamesQuery query = new(parameters.gameType, parameters.playerName, parameters.date, Ended: parameters.ended);
...
// Intentional use of camelCasing instead of PascalCase. For OpenAPI.
file record GetGamesRouteParameters(
